...
; Завдання: ТЕХНОЛОГІЯ РОЗРОБКИ ПРОГРАМ У АРХИТЕКТУРІ ІА32 (Х86). REAL ADRESS MODE
; ВУЗ: КНУУ "КПІ"
; Факультет: ФІОТ
; Курс: 1
; Група: ІТ-з01
...
DATASEG
exCode db 0
message db "Biliy Danilo, Bardah Maksym, Berezovskiy Vladislav, Boychuk Mihailo, Ihor Klimov, Popov Oleksandr, Prihodko Polina, Ropayeva Daria, Trushak Olga, Shatkovsky Vladislav, Yadegari Amirhossein",10,13,'$';Рядок символів для виводу на екран
